...
import MissionVisionSection from '~/components/v1/section/mission-vision/MissionVisionSection.vue';
import CorevaluesSection from '~/components/v1/section/mission-vision/CorevaluesSection.vue';
</script>
