<template>
  <div class="bg-white min-h-screen font-inter">
    ...
    <div class="fixed top-4 right-4 z-50 flex flex-row items-end space-x-1">
      <NuxtLink to="/360vr" target="_blank" rel="noopener noreferrer"
      ...
      <div class="grid lg:grid-cols-5 gap-6 items-start">
        ...
        <div class="lg:col-span-2">
          <div class="relative bg-white rounded-xl overflow-hidden">
            ...
            <el-carousel :interval="2500" arrow="always" indicator-position="none" :height="carouselHeight"
              class="rounded-md">
...
// REFACTORED: `updateHeight` now sets the value of the `carouselHeight` ref
const updateHeight = () => {
  carouselHeight.value = window.innerWidth < 768 ? "230px" : "380px";
};
