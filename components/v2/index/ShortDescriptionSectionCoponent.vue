  ...
  <section class="container mx-auto py-8 md:py-16 ">
    <el-row :gutter="16">
      ...
      <el-col :xs="24" :md="8" class="md:relative">
        <div class="bg-gray-100 md:p-10  flex justify-center items-center rounded-sm shadow-sm md:h-full md:absolute md:inset-0 md:w-[calc(100%+32px)] md:left-[-16px]">
          <div class="">
            <p class="text-gray-900 font-semibold text-lg md:text-xl font-title">Leading Industry</p>
          <p class="text-gray-700 font-bold mt-0 text-md font-title">from
          <span class="text-secondary text-6xl md:text-7xl lg:text-8xl font-bold font-title">1984</span>
          </p>
          </div>
        </div>
      </el-col>
