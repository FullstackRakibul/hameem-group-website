<template>
  <div>
    <section class="welcome-hero-section bg-cover bg-center bg-[url('https://api.hameemgroup.com:9012/Resources/hameem-group-websile/denim-hameem-group-0001.jpeg')] bg-gray-200">
      ...
      <!-- Particle Container -->
      <div class="particles-wrapper relative z-10">
      ...
      <div class="container text-left text-white relative z-20">
        ...
        <p class="text-lg font-sans md:text-xl mb-6">
           Innovating with quality and precision for global markets.
        </p>
        <el-button type="primary" style="background-color: #06253F; color: #fff; border-color: #fff; padding: 5px 10px; font-size:larger;" class="bg-primary font-title" size="large">
...
import { Opacity, type Container } from '@tsparticles/engine'

const options = {
  fullScreen: {
    enable: false, // Particles are restricted to the section only
  },
  background: {
    color: {
...
.welcome-hero-section .particles-wrapper {
