<template>
 <section class="h-screen w-full bg-cover bg-center bg-[url('/assets/HomePageBannerBG-01.jpg')] flex items-center justify-center">
        ...
        <el-col :xs="24" :sm="24" :md="10" class="text-center md:text-right">
          <div class="flex justify-center md:justify-end items-center">
            <el-image 
              ...
              src="/assets/home-banner-img-01.png" 
