      ...
      <div class="mb-16 md:mb-20 flex flex-col md:flex-row md:items-center md:justify-between gap-8">
        ...
        <div class="flex flex-wrap gap-2 md:gap-3">
          <button v-for="tab in tabs" :key="tab" @click="activeTab = tab" :class="[
            ...
            activeTab === tab
              ? 'bg-gradient-to-r from-white to-secondary text-white shadow-lg backdrop-blur-md shadow-blue-500'
      ...
      <div class="grid grid-cols-1 lg:grid-cols-3 gap-8 md:gap-12">
        ...
        <div class="lg:col-span-2 space-y-4 md:space-y-4 flex flex-col">
          <div v-for="(point, index) in activeData.points" :key="index" ref="pointsRef"
            class="group relative flex items-start space-x-4 p-6 md:p-6 bg-white/5 backdrop-blur-xl rounded-2xl border border-white/10 hover:border-white/30 transition-all duration-500 hover:shadow-2xl hover:shadow-white/10"
...
const missionData = {
  ...
  images: [
    'https://hameemgroup.net/assets-profile/1.jpg',
    'https://hameemgroup.net/assets-profile/2.JPG',
    'https://hameemgroup.net/assets-profile/3.JPG',
    'https://hameemgroup.net/assets-profile/4.JPG',
    'https://hameemgroup.net/assets-profile/5.jpg'
  ]
}
...
const visionData = {
  ...
  images: [
    'https://hameemgroup.net/assets-profile/6.JPG',
    'https://hameemgroup.net/assets-profile/7.jpg',
    'https://hameemgroup.net/assets-profile/8.jpg',
    'https://hameemgroup.net/assets-profile/9.jpg',
    'https://hameemgroup.net/assets-profile/10.jpg',
  ]
}
