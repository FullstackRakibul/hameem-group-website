<template>
  <section id="indexGallery" class="py-16 bg-gray-50">
    <div class="container mx-auto px-4">
      ...
      <div class="masonry-grid">
        ...
        >
          <div class="relative overflow-hidden rounded-lg bg-white shadow-sm hover:shadow-lg transition-all duration-300">
            <img
              :src="image.src"
              :alt="image.alt"
