<template>
  <section class="relative w-full min-h-screen bg-cover bg-center bg-fixed overflow-hidden">
    ...
    <div class="relative z-10 max-w-8xl mx-auto px-4 sm:px-6 lg:px-8 py-16 md:py-24 lg:py-32">
      ...
      <div class="mb-20 md:mb-20 flex flex-col md:flex-row md:items-center md:justify-between gap-8">
        <div ref="headerRef" class="space-y-4" :style="headerAnimStyle">
          <div
            ...
            <span class="text-xs md:text-sm font-semibold text-primary uppercase tracking-wider">Our Direction</span>
          </div>
          <h2 class="text-3xl md:text-4xl lg:text-5xl font-bold text-primary leading-tight">
...
import MissionVisionSection from './mission-vision/MissionVisionSection.vue'
      ...
      if (entry.isIntersecting) {
        if (entry.target === headerRef.value) {
          headerAnimStyle.value = {
            opacity: 1,
            transform: 'translateY(0)',
            animation: 'fadeInUp 0.8s cubic-bezier(30, 350, 20, 1)'
          }
        }
