        ...
        <div class="space-y-6">
          ...
          <div class="grid grid-cols-1 sm:grid-cols-2 gap-6">
            <div 
              ...
              :key="index" 
              @mouseenter="setActiveMember(member)"
            ...
            >
              ...
              <div class="absolute -left-4 top-1/2 transform -translate-y-1/2 opacity-0 group-hover/card:opacity-100 transition-all duration-300 group-hover/card:-translate-x-2">
              ...
              <div class="flex flex-col items-center text-center space-y-4">
                ...
                <div class="relative">
                  ...
                  />
                  <!-- Hover overlay -->
                  <div class="absolute inset-0 bg-primary/10 rounded-2xl opacity-0 group-hover/card:opacity-100 transition-opacity duration-300"></div>
                </div>

                <!-- Member Details -->
                <div class="space-y-2">
                  <h4 class="text-lg font-bold text-gray-900 group-hover/card:text-primary transition-colors duration-300">
                    {{ member.name }}
                  </h4>
                  <p class="text-sm font-medium text-gray-600 group-hover/card:text-gray-800 transition-colors duration-300">
                    {{ member.designation }}
                  </p>
                </div>

                <!-- Interaction Indicator -->
                <div class="flex items-center space-x-2 opacity-0 group-hover/card:opacity-100 transition-all duration-300 transform translate-y-2 group-hover/card:translate-y-0">
              ...
              <!-- Card glow effect -->
              <div class="absolute inset-0 rounded-2xl bg-gradient-to-r from-primary/5 to-transparent opacity-0 group-hover/card:opacity-100 transition-opacity duration-500 pointer-events-none"></div>
            </div>
          </div>
          ...
          <div class="mt-8 p-6 bg-gray-50 rounded-2xl border border-gray-100">
            <div class="flex items-center justify-between">
              ...
              <div class="flex -space-x-2">
                ...
                <div v-if="boardMembers.length > 3" class="w-8 h-8 rounded-full bg-primary text-white text-xs flex items-center justify-center border-2 border-white font-medium">
